...
const navigation: {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/pacsnsw",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/pacsnsw/",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/in/pacsnsw",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer className="w-full">
      <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-100">
          &copy; {new Date().getFullYear()} PACS. All rights reserved.
        </p>
      </div>
    </footer>
  );
