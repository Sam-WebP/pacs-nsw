            ...
            <ScrollRevealStagger staggerChildren={0.15} delayChildren={0.1}>
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mt-12">
                ...
                <InvolvementCard
                  ...
                  buttonLink="/contact"
                >
                  We welcome collaborations with businesses, government
                  agencies, schools, and community organisations who share our
                  vision. Your partnership can help us expand our reach.
                </InvolvementCard>
              </div>
            </ScrollRevealStagger>
          </div>
